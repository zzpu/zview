  ...
  <Layout style="height: 100%" class="main">
    <Sider hide-trigger collapsible :width="256" :collapsed-width="64" v-model="collapsed" class="left-sider"
      ...
      <side-menu accordion ref="sideMenu" :active-name="$route.name" :collapsed="collapsed" @on-select="turnToPage"
        ...
        <div class="logo-con">
          <img style='vertical-align:middle;' v-show="!collapsed" :width="1024" :src="maxLogo" key="max-logo"/>
          <img v-show="collapsed" :width="128" :src="minLogo" key="min-logo"/>
        </div>
      </side-menu>
    </Sider>
    <Layout>
...
<script>
  ...
  import minLogo from '@/assets/images/64x64.png'
  import maxLogo from '@/assets/images/128x128.png'
  import './main.less'
