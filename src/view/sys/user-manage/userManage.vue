      ...
      <Row v-show="openSearch" @keydown.enter.native="handleSearch">
        <Form ref="searchForm" :model="searchForm" inline :label-width="70">
          ...
          <span v-if="drop">
            ...
            <Form-item label="登录账号" prop="user_name">
              <Input
                type="text"
...
<script>
  ...
  import checkPassword from '@/zview/check-password'
